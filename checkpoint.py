...
class CheckpointBlock(SimpleExtension, SaveLoadUtils):
    ...
    def __init__(self, saveto, **kwargs):
        ...
        super(CheckpointBlock, self).__init__(**kwargs)
...
class LoadBlock(TrainingExtension, SaveLoadUtils):
    """Loads parameters log and iterations state."""

    def __init__(self, saveto, **kwargs):
        self.folder = saveto
        super(LoadBlock, self).__init__(saveto, **kwargs)
